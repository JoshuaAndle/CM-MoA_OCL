...
class AdapterCLIP(nn.Module):
    ...
    def __init__(self, model_name, peft_method='adapter', peft_encoder='both', device='cpu'):
        ...
        self.model = clip_loader.load(model_name, device=self.device, jit=False, design_details=design_details)
    ...
    def forward(self, image, text_tokens=None):
        ...
        logits_per_image, _, image_features, text_features = self.model(image, text_tokens)
