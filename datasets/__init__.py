...
datasets = {
    ...
    "caltech101": (Caltech101, (0.485, 0.456, 0.406), (0.229, 0.224, 0.225),100),
    "eurosat": (EuroSAT, (0.485, 0.456, 0.406), (0.229, 0.224, 0.225), 10),
    "flowers102": (Flowers102, (0.485, 0.456, 0.406), (0.229, 0.224, 0.225),102),
    "oxford_pet": (OxfordIIITPet, (0.485, 0.456, 0.406), (0.229, 0.224, 0.225),37),
}
...
multipart_datasets = {
    "cifar10": {
                0: (CIFAR10, (0.4914, 0.4822, 0.4465), (0.2470, 0.2435, 0.2616), 10),
                1: (CIFAR100, (0.5071, 0.4867, 0.4408), (0.2675, 0.2565, 0.2761), 100),
                # 2: (TinyImageNet, (0.4802, 0.4481, 0.3975), (0.2302, 0.2265, 0.2262), 200),
            }
